...
public class ETLplayerPossession implements Serializable {
    ...
    public Dataset<Row> playerPossession(){
        Dataset<Row> df = sparkUtil.getSparkSession().read().parquet(ConfigName.PLAYER_POSSESSION + "/04-05-2023");
    ...
    public void convertPlayerPossession(Dataset<Row> df){
        ...
        dfFinal.write().mode("overwrite").parquet("max" + ConfigName.PLAYER_POSSESSION + "/04-05-2023");
    }

    public static void main(String[] args){
        ETLData etl = new ETLplayerPossession();
